...
| --report / --no-report | -r        |          | Output summary report file of the crawl.                                                                                                                                                                     | `--report`  |
| --spreadsheet          | -s        |          | Output a CSV file of the metadata of datasets. See the [spreadsheet column explanation notes](https://github.com/scholarsportal/dataverse-metadata-crawler/wiki/Explanation-of--Spreadsheet-Column-Headers). | False       |
| --metadata-source      | -m        | TEXT     | Filter results by metadata source. Useful for filtering harvested datasets.  Note: In Borealis, it should be specified as `Borealis`                                                                         | None        |
